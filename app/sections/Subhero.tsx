function Subhero() {
  return (
    <section className="subhero bg-bg border-border relative z-2 flex h-min w-full items-start border-t">
      {/* Subhero content goes here */}
      <div className="relative flex w-full max-w-400 flex-row items-start justify-between overflow-visible px-[20px] py-[50px] pt-[150px] md:px-[50px]">
